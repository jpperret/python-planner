...
while date_iter.has_next():
	...
	for y in range(5):
		if not y == 0:
			pdf.line(horizontal_padding, vertical_padding + day_height * y, horizontal_padding + day_width,
					 vertical_padding + day_height * y)
		pdf.line(horizontal_padding + day_horizontal_spacing + day_width, vertical_padding + day_height * y,
				 pdf.w - horizontal_padding, vertical_padding + day_height * y)
	...
	for y in range(4):
		for line in range(1, rows_per_day + 1):
			if not y == 0:
				pdf.line(horizontal_padding + indent_padding, vertical_padding + day_height * y + row_spacing * line,
						 horizontal_padding + day_width, vertical_padding + day_height * y + row_spacing * line)
			pdf.line(horizontal_padding + indent_padding + day_width + day_horizontal_spacing,
					 vertical_padding + day_height * y + row_spacing * line,
					 horizontal_padding + day_width + day_width + day_horizontal_spacing,
					 vertical_padding + day_height * y + row_spacing * line)
